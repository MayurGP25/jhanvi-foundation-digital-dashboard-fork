...
const jobProviderRoutes = require("./routes/jobProviderRoutes"); // include job provider routes
...
app.use("/jobproviders", jobProviderRoutes); // job provider menu, add, view, edit
 
// Server
